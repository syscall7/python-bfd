...
public class ViewSymbols extends FlowPanel implements ModelPlatformBinListener, SelectionHandler<Integer> {
	...
	public ViewSymbols(ModelPlatformBin mpb, StatusIndicator si)
	{
	...
	public void onChange(ModelPlatformBin mpb, int eventFlags)
	{
		if (0 != (eventFlags & mpb.MODEL_EVENT_BIN_CHANGED)) {
			html.setHTML("<H1><center>Feature Coming Soon...</center></H1>");
			//disService.sections(modelPlatformBin.getBytes(), mpb.getPlatform(), callback);
		}
	}
	@Override
