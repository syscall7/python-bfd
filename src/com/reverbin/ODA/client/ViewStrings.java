...
public class ViewStrings extends VerticalPanel implements SelectionHandler<Integer>{
	...
	public ViewStrings(ModelPlatformBin mpb, StatusIndicator si)
	{
		...
		html.setHTML("<pre><insn>No strings found</insn></pre");
		html.setWidth("600px");
	...
	{
		html.setHTML(disOutput.getStringHtml());
	...
	public void onSelection(SelectionEvent<Integer> event) {
		...
		if (event.getSelectedItem() == Main.TAB_INDEX_STRINGS) {
			resize();		
		}
	}
}
